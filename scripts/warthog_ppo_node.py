...
class HuskyPPONode:
    def __init__(self):
        ...
        self.warthog_ppo.read_ppo_policy('./model1')
    ...
    def pose_odom_cb(self, data):
        ...
        if self.got_odom:
            return
        x = data.pose.pose.position.x + 0.2
        y = data.pose.pose.position.y + 0.2
